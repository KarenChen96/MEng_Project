...
# Need to install PIL to run this script
# type "sudo apt-get install python-imaging-tk" in an terminal window
...
testAreaCount = 4
testBorders = [ [[1,50],[1,20]], [[51,100],[1,40]], [[1,50],[41,80]], [[51,100],[41,80]]]  # [ [[start pixel on left side,end pixel on right side],[start pixel on top side,stop pixel on bottom side]] ]
# [[51,100],[1,40]], [[1,50],[41,80]], [[51,100],[41,80]]
            ...
            for x in range(testBorders[z][0][0]-1, testBorders[z][0][1]): # = xrange(0,100) with default-values
                for y in range(testBorders[z][1][0]-1, testBorders[z][1][1]):   # = xrange(0,75) with default-values; testBorders are NOT zero-based, buffer1[x,y] are zero-based (0,0 is top left of image, testWidth-1,testHeight-1 is botton right)
                    ...
                    if (changedPixels > sensitivity):
                        ...
                        print("The motion is happening in area %i" % (z+1))
